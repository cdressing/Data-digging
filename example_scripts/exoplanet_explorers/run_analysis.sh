...
classfile=/Users/courtney/Dropbox/exoplanet_explorers/data/mini-exoplanet-explorers-classifications.csv
weight=0 #0 = no weights, 1 = calculate & use weights
outfile=exoplanet_explorers_aggregate_results.csv
